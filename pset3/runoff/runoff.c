...
int find_min(void)
{
    int menorVoto = voter_count;
    
    for(int c = 0; c < candidate_count; c++){
        if(candidates[c].votes < menorVoto && candidates[c].eliminated == false){
            menorVoto = candidates[c].votes;
        }
    }
